<div class="social">
    ...
    <?php endif ?>
    <?php if($site->socialPhone()->isNotEmpty()) : ?>
        <a href="call:<?php echo $site->socialPhone()->html() ?>">
            <i class="fa fa-phone"></i>
        </a>
    <?php endif ?>
    <?php if($site->socialAddress()->isNotEmpty()) : ?>
        <a href="<?php echo $site->socialAddress()->html() ?>">
